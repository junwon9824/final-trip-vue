            ...
            <div class="col-5 d-flex justify-content-center align-items-center">
                <div class="col-9 d-flex flex-column justify-content-around" style="height: 80%">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control py-2" id="userAddress" placeholder="주소 입력하세요" />
                    </div>

                    <div class="d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success col-6 py-2 mx-1 fw-bold">취소</button>
                        <button type="button" class="btn btn-success col-6 py-2 mx-1 fw-bold text-white">
                            회원가입
                        </button>
                    </div>
                </div>
